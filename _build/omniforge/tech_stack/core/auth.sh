...
# Requires:
#   - PROJECT_ROOT
#   - core/database to be completed (Drizzle ORM)
# =============================================================================
# Contract:
...
if ! has_script_succeeded "core/database"; then
    log_error "Database setup (core/database) must complete before auth setup"
